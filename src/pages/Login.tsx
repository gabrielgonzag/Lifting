...
export default function Login(_props: {
  ...
  return (
    <AuthFrame
      copy="No momento, o acesso ao LIFTING esta disponivel apenas com conta Google."
    ...
    >
      <div className="grid gap-5">
        ...
        <div className="rounded-md border border-white/10 bg-white/[.04] p-4 text-sm text-zinc-300">
          Login por email, senha e recuperacao de senha estao temporariamente indisponiveis.
        </div>
