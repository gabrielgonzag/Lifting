...
export default function AuthSuccess({ onNavigate }: { onNavigate: (route: AppRoute) => void }) {
  return (
    <AuthShell copy="Seu cadastro foi concluido. Verifique seu email para confirmar o acesso ao LIFTING." kicker="Cadastro enviado" title="Conta criada com sucesso">
