...
function ProgressCharts({ student }: { student: StudentDashboard }) {
  return (
    <Suspense fallback={<div className="grid gap-4 xl:grid-cols-2"><Card className="h-72 animate-pulse p-4" /><Card className="h-72 animate-pulse p-4" /></div>}>
      <StudentProgressCharts student={student} />
    </Suspense>
  );
}
