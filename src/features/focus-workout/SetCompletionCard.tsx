...
export function SetCompletionCard({
  ...
  return (
    <motion.section
      ...
      className="rounded-[28px] border border-amber-300/25 bg-[radial-gradient(circle_at_50%_0%,rgba(251,191,36,.20),rgba(255,255,255,.04)_42%,rgba(255,255,255,.02)_100%)] p-5 text-center shadow-[0_0_60px_rgba(251,191,36,.14)]"
