    ...
    exercises: [
      {
        ...
        sets: [
          { id: "bench-a-1", weight: 70, reps: 8, rest: 120 },
          { id: "bench-a-2", weight: 72.5, reps: 6, isPr: true, prType: "weight", rest: 150, completed: true },
        ],
      },
      {
        id: "logged-shoulder-a",
        exerciseId: "ombro-2-desenvolvimento-com-halteres",
        sets: [{ id: "shoulder-a-1", weight: 24, reps: 10, rest: 90 }],
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        sets: [
          { id: "squat-a-1", weight: 95, reps: 6, rest: 150 },
          { id: "squat-a-2", weight: 100, reps: 5, isPr: true, prType: "weight", rest: 180, completed: true },
        ],
      },
      {
        id: "logged-thrust-a",
        exerciseId: "gluteo-1-hip-thrust-com-barra",
        sets: [{ id: "thrust-a-1", weight: 120, reps: 8, rest: 120 }],
      },
    ],
  },
];
